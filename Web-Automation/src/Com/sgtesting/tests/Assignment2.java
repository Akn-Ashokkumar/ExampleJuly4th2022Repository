...
public class Assignment2 {
    ...
    private static void ModifiyUsername()
    {
    	try {
			...
			oBrowser.findElement(By.name("lastName")).sendKeys("Mraj");
			oBrowser.findElement(By.name("email")).sendKeys("akn.ashu96@gmail.com");
			oBrowser.findElement(By.name("username")).sendKeys("Sagar");
			oBrowser.findElement(By.name("password")).sendKeys("Wecome1");
			oBrowser.findElement(By.name("passwordCopy")).sendKeys("Wecome1");
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//span[text()='Create User']")).click();
			Thread.sleep(2000);
		} catch (Exception e) {

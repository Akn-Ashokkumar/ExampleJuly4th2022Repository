...
public class Assignment4 {
    ...
    private static void ModifyTask6()
    {
    	try {
    		...
    		Thread.sleep(2000);
    		oBrowser.findElement(By.xpath("//*[@id=\"taskListBlock\"]/div[2]/div[2]/div[1]/div[3]/div[2]/div/div[1]/textarea")).sendKeys("extra Determination, passion necessary");
        	Thread.sleep(2000);
    	}
    	catch (Exception e) {
			e.printStackTrace();
